...
Основной кабинет Bullgram на React/Vite поверх текущего backend API.
...
## Зачем это отдельно
Bullgram уже вырос в полноценное приложение с тяжелым state, triage-потоками и операционными экранами. Этот app нужен, чтобы:
