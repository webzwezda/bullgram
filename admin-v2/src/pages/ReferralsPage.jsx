  ...
  async function loadUserbotCenterForDm() {
    ...
    try {
      ...
      if (!payload.userbotId) {
        window.alert('Нет рабочего юзербота, который напишет. Подключи и активируй юзербота в приложении «Юзербот» (/userbot/accounts).');
        return null;
      }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-400 font-bold opacity-60 cursor-not-allowed">
                    {state.economics?.bullgramFeePercent || 1}%
                  </div>
                </div>
              </div>
