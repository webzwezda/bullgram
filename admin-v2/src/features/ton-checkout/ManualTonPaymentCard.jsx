  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white overflow-hidden">
      <div className="flex flex-col md:flex-row">
        {qrSrc ? (
          <div className="md:w-[240px] md:shrink-0 p-4 flex flex-col items-center justify-center gap-2.5 border-b md:border-b-0 md:border-r border-slate-100 bg-slate-50/50">
            {hasTrustQr && hasTonQr ? (
