        ...
        <div className="overflow-hidden rounded-[28px] border border-border bg-card shadow-[0_24px_64px_rgba(15,23,42,0.08)]">
          <div className="grid lg:grid-cols-[minmax(0,1.2fr)_360px]">
            <section className="relative overflow-hidden px-6 py-8 sm:px-8 sm:py-10">
              <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-r from-blue-100/70 via-indigo-50/50 to-transparent" />
              <div className="relative space-y-8">
                <div className="inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50/60 px-3 py-1 text-[11px] font-black uppercase tracking-[0.18em] text-blue-800">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-4 shadow-sm backdrop-blur-xs">
            ...
            <aside className="border-t border-border bg-slate-50/80 px-6 py-8 sm:px-8 sm:py-10 lg:border-t-0 lg:border-l">
              <div className="space-y-5">
                ...
                <Button className="h-11 w-full rounded-xl text-sm font-semibold flex items-center justify-center gap-2 cursor-pointer shadow-sm hover:shadow-md transition-shadow" onClick={login}>
                  <svg className="w-4 h-4 mr-1 shrink-0 bg-white p-0.5 rounded-xs" viewBox="0 0 24 24">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-4 text-sm leading-6 text-slate-500 shadow-xs flex items-start gap-2">
