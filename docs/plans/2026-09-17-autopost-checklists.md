...
**Дополнение 2026-09-18.** Секция «Чек-листы» в админке удалена по решению владельца (фича AI-only, управление агентом через Bullgram MCP/REST; REST-ручки и бот-меню в боте остались). Дизайн-критика админ-секции отменена.
