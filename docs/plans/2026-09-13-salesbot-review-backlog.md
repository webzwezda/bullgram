> **SUPERSEDED / ЗАКРЫТ 2026-09-16** — открытых пунктов нет: спот-чек кода 2026-09-16: assertOwnedSalesBot используется, owner-гайды на месте, хардкодов api_id нет — пункты выполнены в сессиях после создания файла
