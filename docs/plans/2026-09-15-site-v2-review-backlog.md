...
1. og:image 1200×630 + переход на summary_large_image
2. шрифт: подключить Manrope / оставить системный / Geist (+почистить woff2)
3. admin-поверхность для access_requests (кто видит ПИИ)
4. диплинки кошельков проверить на реальных устройствах (nano vs decimal, Trust memo)
5. смоук первого логина после PKCE (Google + Telegram)
