...
// same source as `createAuthorizedClient`). This prevents Telegram from
// seeing an api_id mismatch (e.g. auth_key created with api_id=4 for Android
// but initConnection claims api_id=2040 for Web) — which is the kind of
// signal that gets accounts flagged.
//
