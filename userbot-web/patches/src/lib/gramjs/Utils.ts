...
export function getDC(dcId: number, downloadDC = false) {
    ...
    //
    // Source of truth: https://core.telegram.org/dcs
    switch (dcId) {
        case 1:
            return {
                id: 1,
                ipAddress: '2001:b28:f23d:f001::a',
                port: 443,
            };
        case 2:
            return {
        ...
        case 3:
            return {
                id: 3,
                ipAddress: '2001:b28:f23d:f003::a',
                port: 443,
            };
        case 4:
            return {
                id: 4,
                ipAddress: '2001:67c:4e8:f004::a',
                port: 443,
            };
        case 5:
            return {
                id: 5,
                ipAddress: '2001:b28:f23f:f005::a',
                port: 443,
            };
        default:
