      ...
      rollupOptions: {
        output: {
          manualChunks: {
            ...
            'vendor-ui': ['lucide-react', '@radix-ui/react-dialog', '@radix-ui/react-dropdown-menu', '@radix-ui/react-popover', '@radix-ui/react-toast', '@radix-ui/react-tooltip', 'sonner', 'clsx', 'class-variance-authority', 'tailwind-merge']
          }
        },
        ...(analyze ? {
          plugins: [
