  ...
  return (
    <section className="marketing-page">
      <SectionIntro
        ...
        text="BullRun нужен там, где обычный “бот для оплаты” уже не справляется, потому что поверх оплаты надо еще контролировать доступ, входящие, базу и работу команды."
      />

      <FeatureGrid items={FEATURES} />

      <HighlightBand
        title="Где BullRun выигрывает"
