...
const steps = [
  {
    ...
    text: 'Создаёте бота через @BotFather, вставляете токен в BullRun. 30 секунд, настройка закончена.'
  },
  {
    icon: CreditCard,
  ...
  },
  {
    ...
    text: 'Клиент переходит по ссылке, оплачивает по реквизитам, присылает чек. BullRun фиксирует и проверяет.'
  },
  {
    icon: TrendingUp,
...
const audiences = [
  ...
  },
  {
    ...
    text: 'Платный чат с экспертами, закрытое сообщество предпринимателей или клуб по интересам. Вы продаёте доступ, BullRun ведёт базу и контролирует продления.'
  }
];
...
const outcomes = [
  {
    ...
    text: 'Деньги от клиентов поступают на ваши P2P-реквизиты или TON-кошелёк. BullRun не держит деньги, не берёт процент — ведёт только статус и чек.'
  },
  {
    icon: Bot,
  ...
  },
  {
    ...
    text: 'BullRun сам напоминает об истекающем доступе, ведёт статус продления и фиксирует новую оплату. Вы просто видите: кто продлил, а кто нет.'
  },
  {
    icon: Users,
...
const faqItems = [
  {
    question: 'Деньги идут через BullRun?',
    answer: 'Нет. BullRun не держит ваши деньги и не берёт процент. Клиенты оплачивают по вашим P2P-реквизитам или на ваш TON-кошелёк. BullRun только фиксирует оплату и выдаёт доступ.'
  },
  {
  ...
  },
  {
    ...
    answer: 'BullRun напоминает о продлении. Если клиент не продлевает, доступ автоматически закрывается. Вам не нужно вручную исключать людей.'
  },
  {
    question: 'Нужен ли мне свой сервер или хостинг?',
    answer: 'Нет. BullRun работает облачно. Вы создаёте бота через @BotFather, вставляете токен — и всё. Настройка занимает меньше минуты.'
  },
  {
    question: 'Что если у меня уже есть бот для оплаты?',
    answer: 'BullRun не конфликтует с существующими ботами. Вы можете использовать его как основной инструмент для кассы и доступа, а старый бот — оставить для других задач.'
  },
  {
