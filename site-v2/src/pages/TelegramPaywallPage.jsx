...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Trial — 14 дней бесплатно. Pro — 4.5 TON в год, оплата в TON через TonConnect. Подробности на странице тарифов. Скидок и сигнальщиков нет — цена фиксирована.'
  }
];
