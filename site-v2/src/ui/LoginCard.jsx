...
export function LoginCard() {
  ...
  return (
    <div className="flex flex-col gap-2 mb-8 mt-2">
      ...
      <button
        className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-sky-700 hover:bg-sky-800 text-white text-sm font-bold rounded-xl transition-all border border-sky-600 shadow-sm hover:shadow-md"
        type="button"
      ...
      {authError ? (
        <div className="text-xs font-semibold text-rose-700 px-1">{authError}</div>
      ) : null}
    </div>
  );
}
